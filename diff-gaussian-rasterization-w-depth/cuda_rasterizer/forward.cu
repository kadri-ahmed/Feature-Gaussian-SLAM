...
//             D += dep * alpha * T;
			...
			// considered gaussians are sorted by distance to camera
			// take gaussian with minimum distance
	...
	if (inside)
	{
		...
		{
			out_gaussian[pix_id] = most_contributing_ind;//nearest_ind;//
